...
import { getRandomEmails, phishingTips, showSuccessToast, showErrorToast } from '../utils/gameUtils';
...
const PhishingChallenge: React.FC = () => {
  ...
  const [emails, setEmails] = useState(getRandomEmails());
        ...
        >
          <div className="flex items-start p-4">
            ...
            <div>
              ...
              <ul className="list-disc pl-3 space-y-0.5 text-sm">
